graph TD
    ...
    A3 --> F3
    C1 --> C2{¿Datos e iniciativas suficientes?}:::decision
    C2 -- NO --> C3[Expandir a los otros 5 países del Top 10]:::accion
    C3 --> C4
    C2 -- SÍ --> C4[Aplicar Tips de Búsqueda]:::accion
    
    C4 -.-> T1[Uso de dominios locales ej. .go.jp]
    C4 -.-> T2[Búsqueda por instituciones y ciudades afectadas]
